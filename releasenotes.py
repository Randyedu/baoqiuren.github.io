This Python script get from github pr number all commits, parses its JIRA task with rule you will provide and that get information from JIRA and send report to slack. Finally tasks will be set to done and commented as deployed
